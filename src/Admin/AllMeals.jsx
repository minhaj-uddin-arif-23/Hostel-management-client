...
export default function AllMeals() {
  ...
  return (
    ...
    <div className="mb-8 flex justify-between items-center">
      <div className="font-semibold text-lg text-gray-700">Total {meals.length} Meals</div>
      <div>
        <button className="btn btn-outline btn-sm text-gray-700 hover:bg-gray-100">Sort by Like</button>
        <button className="btn btn-outline btn-sm text-gray-700 hover:bg-gray-100 ml-4">Sort by Rating</button>
      </div>
    </div>
    ...
    <div className="overflow-x-auto">
      <table className="table-auto w-full border-collapse border border-gray-200">
        ...
        <tbody>
          {meals.map((item) => (
            <tr className="hover:bg-gray-50 transition duration-200" key={item._id}>
              ...
              <td className="px-4 py-3 text-sm text-gray-700">{item.review_count}</td>
