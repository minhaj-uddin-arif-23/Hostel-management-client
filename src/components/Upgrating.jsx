    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <div className="card bg-gray-100 w-80 shadow-lg border border-gray-300">
        <div className="card-body text-center">
          ...
          <p className="text-lg text-gray-600 my-3">Basic amenities for students</p>
          ...
          <Link
          to={`/silver/${id}`}
          className="btn btn-outline btn-primary w-full">Subscribe</Link>
        </div>
      </div>
      ...
      <div className="card bg-yellow-100 w-80 shadow-lg border border-yellow-400">
        <div className="card-body text-center">
          ...
          <p className="text-lg text-yellow-600 my-3">Enhanced comfort and services</p>
          ...
          <Link 
         to={`/gold/${id}`}
          className="btn btn-outline btn-warning w-full">Subscribe</Link>
        </div>
      </div>
      ...
      <div className="card bg-blue-100 w-80 shadow-lg border border-blue-500">
        <div className="card-body text-center">
          ...
          <p className="text-lg text-blue-600 my-3">Luxury experience for students</p>
          ...
          <Link   to={`/platinum/${id}`} className="btn btn-outline btn-info w-full">Subscribe</Link>
        </div>
      </div>
    </div>
  );
